...
|------|-------------|------|---------|:--------:|
| autoclass | While set to true, the bucket will automatically be assigned a Storage Class based on the size and access patterns of the objects. If enabled, exclusive with lifecycle\_rules. | `bool` | `false` | no |
