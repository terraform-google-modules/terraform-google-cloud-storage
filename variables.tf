...
variable "lifecycle_rules" {
  type = set(object({
    ...
    # - is_live - (Optional, Deprecated) Use with_state instead. Set to true to match live objects, false to match archived objects. Automatically converted to with_state.
