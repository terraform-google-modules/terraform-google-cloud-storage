...
variable "autoclass" {
  description = "Map with bucket_name, the bucket will automatically be assigned a Storage Class based on the size and access patterns of the objects. If enabled, exclusive with lifecycle_rules."
  type        = map(bool)
  default     = {}
}
